...
namespace ConsoleApp_for_Self_Hosted_WS
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Example adding :
            // Uri tcpUrl = new Uri("net.tcp://localhost:8090/MyService/PolyBikingService");
            // ServiceHost host = new ServiceHost(typeof(MyCalculatorService.PolyBikingService), httpUrl, tcpUrl);
